...
p2 <- ggplot(tennis, aes(x = winner_age, y = minutes)) +
  ...
  labs(x = "Winner Age", y = "Match Duration (min)",
       title = "Winner Age vs. Match Duration", subtitle = "Positive relationship: winner age & match duration") +
  theme_minimal() 
...
p1 <- ggplot(tennis, aes(x = loser_age, y = minutes)) +
  ...
  labs(x = "Loser Age", y = "Match Duration (min)",
       title = "Loser Age vs. Match Duration", subtitle = "Negative relationship: loser age & match duration") +
  theme_minimal()
...
p1 <- ggplot(tennis, aes(x = winner_hand, y = minutes)) +
  ...
  labs(x = "Winner Playing Hand", y = "Match Duration (min)",
       title = "Winner's Hand vs. Match Duration", subtitle = "Right-handed winners: highest avg match") +
  theme_minimal()

p2 <- ggplot(tennis, aes(x = loser_hand, y = minutes)) +
  geom_boxplot() +
  labs(x = "Loser Playing Hand", y = "Match Duration (min)",
       title = "Loser's Hand vs. Match Duration", subtitle = "Right-handed losers: highest avg matches") +
  theme_minimal()
